...
|   |-- REFERENCES.md                     # outside work used, in AMS format, and where each is used
...
|   |-- mode_budget.py                    # which tendency term feeds a growing mode (kinetic-energy budget of the round-off difference)
